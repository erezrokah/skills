...
- Collapsible "Why This Matters" section with real-world supply chain attack examples (include links and CVEs):
  - GitHub Actions: Trivy ([CVE-2026-33634](https://nvd.nist.gov/vuln/detail/CVE-2026-33634)), [KICS](https://www.wiz.io/blog/teampcp-attack-kics-github-action) (CVE-2026-33634), [LiteLLM](https://docs.litellm.ai/blog/security-update-march-2026) (CVE-2026-33634), reviewdog ([CVE-2025-30154](https://nvd.nist.gov/vuln/detail/CVE-2025-30154)), tj-actions/changed-files ([CVE-2025-30066](https://nvd.nist.gov/vuln/detail/CVE-2025-30066))
