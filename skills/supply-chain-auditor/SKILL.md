...
- Collapsible "Why This Matters" section with real-world supply chain attack examples (include links and CVEs):
  - GitHub Actions: tj-actions/changed-files ([CVE-2025-30066](https://nvd.nist.gov/vuln/detail/CVE-2025-30066)), reviewdog ([CVE-2025-30154](https://nvd.nist.gov/vuln/detail/CVE-2025-30154)), Trivy ([CVE-2026-33634](https://nvd.nist.gov/vuln/detail/CVE-2026-33634)), [KICS](https://www.wiz.io/blog/teampcp-attack-kics-github-action) (CVE-2026-33634), [LiteLLM](https://snyk.io/blog/poisoned-security-scanner-backdooring-litellm/) (CVE-2026-33634)
  - Package registries: [event-stream](https://github.com/advisories/GHSA-mh6f-8j2x-4483) (2018), [ua-parser-js](https://github.com/advisories/GHSA-pjwm-rvh2-c87w) (2021), [colors.js](https://nvd.nist.gov/vuln/detail/CVE-2021-23567) ([CVE-2021-23567](https://nvd.nist.gov/vuln/detail/CVE-2021-23567), 2022), [PyTorch torchtriton](https://pytorch.org/blog/compromised-nightly-dependency/) (2022), [color npm account takeover](https://github.com/Qix-/color/security/advisories/GHSA-qrmh-qg46-72pp) ([CVE-2025-59143](https://nvd.nist.gov/vuln/detail/CVE-2025-59143), 2025), [Axios npm compromise impacting OpenAI](https://openai.com/index/axios-developer-tool-compromise/) (2026)
