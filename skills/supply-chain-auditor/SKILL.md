...
- Collapsible "Why This Matters" section with real-world supply chain attack examples (include links and CVEs):
  ...
  - Package registries: [event-stream](https://github.com/advisories/GHSA-mh6f-8j2x-4483) (2018), [ua-parser-js](https://github.com/advisories/GHSA-pjwm-rvh2-c87w) (2021), colors.js ([CVE-2021-23567](https://nvd.nist.gov/vuln/detail/CVE-2021-23567), 2022), [PyTorch torchtriton](https://pytorch.org/blog/compromised-nightly-dependency/) (2022), [Axios npm compromise impacting OpenAI](https://openai.com/index/axios-developer-tool-compromise/) (2026)
